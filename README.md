...
A user-global Pi extension that adds `/reset-rate-limit`. The command consumes one real OpenAI Codex rate-limit reset credit for the account authenticated through Pi's `openai-codex` provider.
